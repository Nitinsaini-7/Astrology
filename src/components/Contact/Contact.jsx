  ...
  return (
    <div className="mt-14">
      <div className="flex items-center justify-center py-10">
        ...
        <h1 className="text-3xl font-bold uppercase text-black">Contact Us</h1>
        <span className=" px-1 py-4 bg-orange-400 ml-1"></span>
      </div>

      <div className="my-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-yellow-500 rounded-lg">
        <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
          ...
          <div className="bg-gray-100 p-6 rounded-lg">
            ...
            <form className="mt-8 space-y-4">
              ...
              <button
                type="button"
                className="text-white bg-blue-600 hover:bg-blue-700 duration-300 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
