    ...
    <div className="flex items-center justify-center h-screen relative bg-[url(/a2.jpg)] bg-cover bg-center bg-no-repeat">
      <div className="md:w-2/5 w-full mx-4">
        <div className="absolute inset-0 bg-black md:bg-opacity-10 bg-opacity-40">
          <Link to="/">
            <button className="bg-white rounded-md bg-opacity-20 group hover:bg-white hover:text-black duration-200  backdrop-blur-sm text-white absolute top-5 right-5 p-2 flex justify-center items-center gap-2 ">
              Back Home
              <svg
                className="w-4 fill-white group-hover:fill-black duration-200"
        ...
        <div className="  relative flex w-full h-full -py-1 py-4 flex-1 flex-col justify-center backdrop-blur-sm bg-white bg-opacity-10 px-6 lg:px-8 shadow-[rgba(0,_0,_0,_0.2)_0px_30px_90px] rounded-md">
